...
$lbi = "【運行情報】市営地下鉄ブルーライン >> ".$lbi." http://cgi.city.yokohama.lg.jp/koutuu/kinkyu2/info.php?line=1";

    if ($lbi == "【運行情報】市営地下鉄ブルーライン >> 平常通り運転しています。 http://cgi.city.yokohama.lg.jp/koutuu/kinkyu2/info.php?line=1") {
        $lbi = "";
    } else {}

    if ($lbi == "【運行情報】市営地下鉄ブルーライン >>  http://cgi.city.yokohama.lg.jp/koutuu/kinkyu2/info.php?line=1") {
        $lbi = "";
    } else {}
